...
async def T2_Run(): 
    ...
    #await RL.turnRobot(-45,200,250,False,waitForPrompt)
    ...
    await RL.moveAttachment("left",650,1000,False,"hold",False,True,waitForPrompt)
    await RL.driveRobot(-160,450,500,"hold",waitForPrompt)
    await RL.turnRobot(45,400,250,False,waitForPrompt)
 
    if RL.debugL1: print("   mission 02 - move left topsoil sample")
    await RL.driveRobot(330,520,350,False,waitForPrompt)
    #  315 and -40
    await RL.turnRobot(-41,270,300,"hold",waitForPrompt)
    ...
    await RL.turnRobot(14,270,300,"hold",waitForPrompt)
    await RL.driveRobot(30,500,350,"hold",waitForPrompt)
    ...
    await RL.moveAttachment("left",250,900,False,"coast",False,True,waitForPrompt)
    await RL.driveRobot(335,400,250,"hold",waitForPrompt)
    ...
    await RL.driveRobot(-260,400,250,"hold",waitForPrompt)
    await RL.turnRobot(83,270,300,"hold",waitForPrompt)
    #await RL.driveRobot(1800,800,250,"hold",waitForPrompt)
    await RL.driveRobotAndLift(1800,800,250,"left",1850,900,"hold",False,True,waitForPrompt)
