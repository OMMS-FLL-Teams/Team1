...
class RobotConfig:
    ...
    def __init__(self,HubName,HubNumber):
        ...
        # orientation of the hub's display
        self.displayOrientation=Side.RIGHT
        # top_side and font_side orientations of the hub
        self.topSide=Axis.Z
        self.frontSide=Axis.Y*-1
...
robotConfigs[0].displayOrientation=Side.RIGHT
robotConfigs[0].topSide=Axis.Z
robotConfigs[0].frontSide=Axis.Y*-1
...
robotConfigs[1].displayOrientation=Side.RIGHT
...
robotConfigs[2].displayOrientation=Side.RIGHT
robotConfigs[2].WheelDiameter=62.4
robotConfigs[2].AxleTrack=204
...
robotConfigs[2].LeftRightAttachments=True
#
robotConfigs[2].TopAttachmentPort=None
robotConfigs[2].TopAttachmentGearsPresent=False
robotConfigs[2].TopAttachmentGearsCfg=None
#
robotConfigs[2].FrontAttachmentPort=None
robotConfigs[2].FrontAttachmentGearsPresent=False
robotConfigs[2].FrontAttachmentGearsCfg=None
#
robotConfigs[2].LeftAttachmentPort=Port.D
robotConfigs[2].LeftAttachmentGearsPresent=False
robotConfigs[2].LeftAttachmentGearsCfg=None
#
robotConfigs[2].RightAttachmentPort=Port.C
robotConfigs[2].RightAttachmentGearsPresent=True
robotConfigs[2].RightAttachmentGearsCfg=[28,36]
